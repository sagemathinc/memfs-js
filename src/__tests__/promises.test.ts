...
describe("Promises API", () => {
  describe("FileHandle", () => {
    ...
    describe("read(buffer, offset, length, position)", () => {
      ...
      it("Reject when the file handle was closed", async () => {
        ...
        await fileHandle.close();
        return expect(
          fileHandle.read(Buffer.from("foo"), 0, 42, 0)
        ).rejects.toBeInstanceOf(Error);
      });
    });
    ...
    describe(".stat(path, options)", () => {
      ...
      it("Rejects when entry does not exist if throwIfNoEntry is true", async () => {
        await expect(
          vol.stat("/foo", { throwIfNoEntry: true })
        ).rejects.toBeInstanceOf(Error);
      });
      ...
      it("Rejects when entry does not exist if throwIfNoEntry is explicitly undefined", async () => {
        await expect(
          vol.stat("/foo", { throwIfNoEntry: undefined })
        ).rejects.toBeInstanceOf(Error);
      });
    });
    describe(".lstat(path, options)", () => {
      ...
      it("Rejects when entry does not exist if throwIfNoEntry is true", async () => {
        await expect(
          vol.lstat("/foo", { throwIfNoEntry: true })
        ).rejects.toBeInstanceOf(Error);
      });
      it("Rejects when entry does not exist if throwIfNoEntry is not specified", async () => {
      ...
      it("Rejects when entry does not exist if throwIfNoEntry is explicitly undefined", async () => {
        await expect(
          vol.lstat("/foo", { throwIfNoEntry: undefined })
        ).rejects.toBeInstanceOf(Error);
      });
    });
    ...
    describe("utimes(atime, mtime)", () => {
      ...
      it("Reject when the file handle was closed", async () => {
        ...
        await fileHandle.close();
        return expect(
          fileHandle.utimes(fttArrival, fttDeparture)
        ).rejects.toBeInstanceOf(Error);
      });
    });
    describe("write(buffer[, offset[, length[, position]]])", () => {
      ...
      it("Reject when the file handle was closed", async () => {
        ...
        await fileHandle.close();
        return expect(
          fileHandle.write(Buffer.from("foo"))
        ).rejects.toBeInstanceOf(Error);
      });
    });
    describe("writeFile(data[, options])", () => {
      ...
      it("Reject when the file handle was closed", async () => {
        const fileHandle = await promises.open("/foo", "w");
        await fileHandle.close();
        return expect(fileHandle.writeFile("foo")).rejects.toBeInstanceOf(
          Error
        );
      });
    });
  ...
  describe("appendFile(path, data[, options])", () => {
    ...
    it("Reject when trying to write on a directory", () => {
      ...
      return expect(promises.appendFile("/foo", "bar")).rejects.toBeInstanceOf(
        Error
      );
    });
  });
  describe("chmod(path, mode)", () => {
    ...
    it("Reject when file does not exist", () => {
      return expect(promises.chmod("/bar", 0o444)).rejects.toBeInstanceOf(
        Error
      );
    });
  });
  ...
  describe("copyFile(src, dest[, flags])", () => {
    ...
    it("Reject when file does not exist", () => {
      return expect(promises.copyFile("/baz", "/qux")).rejects.toBeInstanceOf(
        Error
      );
    });
  });
  describe("lchmod(path, mode)", () => {
    ...
    it("Reject when file does not exist", () => {
      return expect(promises.lchmod("/baz", 0o444)).rejects.toBeInstanceOf(
        Error
      );
    });
  });
  describe("lchown(path, uid, gid)", () => {
    ...
    it("Reject when file does not exist", () => {
      return expect(promises.lchown("/baz", 0, 0)).rejects.toBeInstanceOf(
        Error
      );
    });
  });
  describe("link(existingPath, newPath)", () => {
    ...
    it("Reject when file does not exist", () => {
      return expect(promises.link("/baz", "/qux")).rejects.toBeInstanceOf(
        Error
      );
    });
  });
  ...
  describe("open(path, flags[, mode])", () => {
    ...
    it("Open an existing file", async () => {
      expect(await promises.open("/foo", "r")).toBeInstanceOf(
        promises.FileHandle
      );
    });
    it("Reject when file does not exist", () => {
  ...
  describe("realpath(path[, options])", () => {
    ...
    it("Return real path of existing file", async () => {
      expect((await promises.realpath("/foo/bar/../qux")).toString()).toEqual(
        "/foo/baz"
      );
    });
    it("Reject when file does not exist", () => {
  ...
  describe("rename(oldPath, newPath)", () => {
    ...
    it("Reject when file does not exist", () => {
      ...
      return expect(promises.rename("/bar", "/baz")).rejects.toBeInstanceOf(
        Error
      );
    });
  });
  ...
  describe("symlink(target, path[, type])", () => {
    ...
    it("Reject when file already exists", () => {
      ...
      return expect(promises.symlink("/bar", "/foo")).rejects.toBeInstanceOf(
        Error
      );
    });
  });
  ...
  describe("utimes(path, atime, mtime)", () => {
    ...
    it("Reject when file does not exist", () => {
      return expect(
        promises.utimes("/bar", fttArrival, fttDeparture)
      ).rejects.toBeInstanceOf(Error);
    });
  });
  describe("writeFile(id, data[, options])", () => {
    ...
    it("Reject when trying to write on a directory", () => {
      ...
      return expect(promises.writeFile("/foo", "bar")).rejects.toBeInstanceOf(
        Error
      );
    });
  });
